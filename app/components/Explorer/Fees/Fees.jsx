...
class FeeGroup extends React.Component {
    ...
    render() {
        ...
        //
        //     console.log(operation_name, fee);
        ...
        //             console.log(operation_name, getConfig(operation_name));
        //             rows.push(
        //                 <tr key={opId.toString() + key}>
        //                     <OperationTitle name={feeName} config={getConfig(operation_name)} included={headIncluded} />
        ...
        //             <tr key={opId.toString() + key}>
        //                 <td>
        //                     <span className={labelClass}>{feeName} {operation_name}</span>
        //                 </td>
        //                 <td>{feeTypes[key]}</td>
        //                 <td style={{textAlign: "right"}}>
        //                     - <sup>*</sup>
...
class Fees extends React.Component {
    ...
    render() {
        const currentFees = this.props.globalObject.toJS().parameters
            .current_fees;

...
export default function EditTemplate({type, value, onChange}: EditTemplateProps) {
    ...
    switch (type) {
        ...
        case "uint32_t":
        case "int64_t":
            element = <EditNumberTemplate value={value as number} onChange={onChange} />;
            break;
        case "bool":
            element = <EditBooleanTemplate value={value as boolean} onChange={onChange} />;
            break;
        default:
            element = <EditStringTemplate value={value as string} onChange={onChange} />;
            break;
    }

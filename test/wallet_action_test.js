    ...
    beforeEach(done => {
        ...
        api.init_promise
            .then(() => {
                ...
                iDB.root
                    .setProperty("current_wallet", "wallet" + suffix)
                    .then(() => {
        ...
        helper
            ...
            .then(() => {
                return createWalletObject().then(wallet_object => {
                    ...
                    var wallet_object_string = JSON.stringify(
                        wallet_object,
                        null,
                        0
                    );
                    ...
                    return createWalletBackup(
                        ...
                        return decryptWalletBackup(
                            backup_private.toWif(),
                            binary_backup
                        ).then(wallet_object2 => {
                            assert(wallet_object2.wallet);
                            var wallet_object2_string = JSON.stringify(
                                wallet_object2,
                                null,
                                0
                            );
                            assert.equal(
                                wallet_object_string,
                                wallet_object2_string
                            );
                            done();
                        });
                    });
